<?php
    ...
    $query = mysqli_query($mysqli, "SELECT a.*, b.nama AS nama_kategori FROM produk a JOIN kategori b ON a.
        ...
        <div class="col-12 col-md-6 mb-5">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <input type="number" class="form-control" value="<?php echo $data
                    ['harga']; ?>" name="harga" required>
                </div>
                <div>
            ...
            <?php 
                        ...
                        $queryUpdate = mysqli_query($mysqli, "UPDATE produk SET kategori_id='$kategori', 
            ...
            ?>
                                <div class="alert alert-warning mt-3" role="alert">
                                    File tidak boleh lebih dari 800 Kb
                                </div>
            <?php 
                            }
                            else{
            ...
            ?>
                                    <div class="alert alert-warning mt-3" role="alert">
                                        File wajib bertipe jpg atau png atau jpeg
                                    </div>    
            <?php 
                                }
                                else{
                                    ...
                                    $queryUpdate = mysqli_query($mysqli, "UPDATE produk SET 
