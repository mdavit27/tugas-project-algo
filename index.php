<?php
    require "koneksi.php";
    $queryProduk = mysqli_query($mysqli, "SELECT id, nama, harga, foto, detail FROM produk LIMIT 6");
?>
...
<body>
    ...
    <!-- banner -->
    <div class="container-fluit banner d-flex align-items-center">
        ...
        <div class="container text-center">
            ...
            <div class="row mt-5">
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-t-shirt d-flex justify-content-center
                    align-items-center">
                        <h4 class="text-white"><a class="no-decoration" href="produk.php
                        ?kategori=T-Shirt">T-Shirt</a></h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="highlighted-kategori kategori-hoodie d-flex justify-content-center
                    align-items-center">
                         <h4 class="text-white"><a class="no-decoration" href="produk.php?
                         kategori=Hoodie">Hoodie</a></h4>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                ...
                <div class="col-sm-6 col-md-4 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            warna2 text-white">Lihat Detail</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
