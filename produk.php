<?php
    ...
    // get produk by kategori
        ...
        $queryGetKategoriId = mysqli_query($mysqli,
            "SELECT id FROM kategori WHERE nama='$kategori'"
        );
        $kategoriId = mysqli_fetch_assoc($queryGetKategoriId);

        $queryProduk = mysqli_query($mysqli,
            "SELECT * FROM produk WHERE kategori_id='" . $kategoriId['id'] . "'"
        );
    }
